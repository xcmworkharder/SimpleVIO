#ifndef SIMPLE_VIO_EDGE_REPROJECTION_H
#define SIMPLE_VIO_EDGE_REPROJECTION_H
...
public:
    ...
    EdgeReprojection(const Vec3& pts_i, const Vec3& pts_j)
            : Edge(2, 4, std::vector<std::string>{
            "VertexInverseDepth", "VertexPose",
...
#endif //SIMPLE_VIO_EDGE_REPROJECTION_H
