#ifndef SIMPLE_VIO_IMU_INTEGRATION_H
#define SIMPLE_VIO_IMU_INTEGRATION_H
...
public:
     ...
     * @param _dp_dba
     */
    void getJacobians(Mat33& dr_dbg, Mat33& dv_dbg,
                      Mat33& dv_dba, Mat33& dp_dbg, Mat33& dp_dba) const {
        dr_dbg = dr_dbg_;
        dv_dbg = dv_dbg_;
        dv_dba = dv_dba_;
        dp_dbg = dp_dbg_;
...
#endif //SIMPLE_VIO_IMU_INTEGRATION_H
