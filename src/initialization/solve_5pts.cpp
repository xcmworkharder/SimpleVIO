...
//namespace cv {
//    void decomposeEssentialMat(InputArray _E, OutputArray _R1,
...
//    }
//
//    int recoverPose(InputArray E, InputArray _points1,
//                    InputArray _points2, InputArray _cameraMatrix,
...
//
//    int recoverPose(InputArray E, InputArray _points1,
//                    InputArray _points2, OutputArray _R,
//                    OutputArray _t, double focal,
...
// 返回后帧到前帧的旋转和平移矩阵(recoverPose返回前帧到后帧的旋转和平移矩阵,进行了R转置和T取反)
